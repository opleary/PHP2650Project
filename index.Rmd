...
In order to choose the variables that we want to use in our models, we will first run a cox proportional
...
The output from the test tells us that the test is statistically significant for bili, protime, and the interaction between bili and ast at a significance level of 0.05. It's also globablly statistically significant with a p-value of 0.04. Thus, the PH assumption is violated.

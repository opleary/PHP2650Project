...
The prediction errors for each of our models will be implemented in the `pec` package in R. We implement bootstrap cross-validation to get our estimates for the integrated brier scores. The models are assessed on the data samples that are NOT in the bootstrap sample (OOB data).
...
In hyperparameter tuning, we found that an mtry value of 1 and a nodesize of 5 produced the lowest out-of-bag error (0.107).

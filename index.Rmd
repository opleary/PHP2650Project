...
![](img/survival_func.png){width="198"}
...
Both survival functions and hazard functions are alternatives to probability density functions and better suited for survival data.

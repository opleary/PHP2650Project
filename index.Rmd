...
We'll split our data into a 75/25 training-testing set. Our training and testing sets have 846 and 283 observations respectively.
...
#turn_mae_tbl <- data.frame(mtry = 2:8, MAE = maes_turn)
#kable(turn_mae_tbl) %>%
 # kable_styling()

```

| mtry | Training Mean Absolute Error |
|------|------------------------------|
| 2    | 33.33                        |
| 3    | 33.92                        |
| 4    | 34.50                        |

...
```{r}
# don't need training and testing
#set.seed(1)
...
We'll run a conditional inference forest model.
...
#predictSurvProb(turn_cif, newdata = test_turn[, -c(1:2)], times = test_turn$stag)
...
fitpec <- pec(list("cforest" = turn_cif), data=train_turn, 

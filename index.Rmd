...
In hyperparameter tuning, we found that an mtry value of 1 and a nodesize of 4 produced the lowest out-of-bag error (0.106).
...
| 153 | 2224 | 0     | 2583                | 3584                |

The observations that experiences death dies at the exact time that the model predict that patient has a 50% chance of survival. The two other observations, which are censored, have more time beyond the scope of their observational periods before they have a 50% chance of surviving.
